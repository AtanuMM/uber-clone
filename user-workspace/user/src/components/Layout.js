...
const navigation = [
  ...
  { name: 'Book Ride', to: '/book-ride', icon: MapIcon },
  { name: 'Active Ride', to: '/active-ride', icon: TruckIcon },
  { name: 'Ride History', to: '/ride-history', icon: ClockIcon },
  { name: 'Payment', to: '/payment', icon: CreditCardIcon },
      ...
      >
        ...
        <div className="relative flex flex-col w-64 min-h-0 bg-white border-r border-gray-200">
          <div className="flex items-center justify-between flex-shrink-0 px-4 py-4">
            <span className="text-xl font-semibold text-gray-800">Rider App</span>
            <button
              type="button"
