...
// Status Badge specifically for displaying ride status states
const StatusBadge = ({ status, className = '' }) => {
  const statusConfig = {
    searching: { variant: 'info', label: 'Finding Driver' },
    confirmed: { variant: 'success', label: 'Driver Found' },
    arriving: { variant: 'warning', label: 'Driver Arriving' },
